...
For my capstone project, I am interested in working on a project that combines software development, data, and real-world problem-solving. As my co-op rotations have allowed me to work in several different areas of technology, I am open to projects that allow me to apply those experiences while also learning something new. My main goal for my capstone project is to work on something that challenges me technically while allowing me to contribute to the skills I have developed throughout my Computer Science education and co-op experiences. I would also like the opportunity to learn new technologies, collaborate with a team, and create a final product that provides meaningful value to its users. My group and I have not aligned our topic, however, we have some ideas that we are currently looking into.
